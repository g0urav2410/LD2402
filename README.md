...
Each number is a signal strength in dB for that distance band. The further
down the list, the further away. When it goes above that gate's threshold
(see below), detection fires.
